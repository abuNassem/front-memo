...
const LoginForm = () => {
  ...
  return (
    <form onSubmit={login} className="flex flex-col items-center gap-[40px]">
      ...
      {error && (
        <div
          className="w-full rounded-lg border-2 border-zinc-700/50 text-white 
      ...
      {isLoading ? (
        ...
        <button
          ...
          duration-500 font-bold text-zinc-100/50 hover:text-zinc-100 hover:rounded-[30px] relative"
        >
          Login
        </button>
      )}
